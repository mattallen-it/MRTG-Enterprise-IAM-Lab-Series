...
The basic certificate trust path tested in this lab was:
...
images/01-pre-lab-19-checkpoint.png
...
images/02-adcs-role-selected.png
...
images/03-certification-authority-role-service-selected.png
...
images/04-adcs-installation-complete.png
...
images/05-server-manager-adcs-configuration-required.png
...
images/06-enterprise-ca-selected.png
...
images/07-root-ca-selected.png
...
images/08-create-new-private-key-selected.png
...
images/09-cryptography-settings-configured.png
...
images/10-ca-name-configured.png
...
images/11-ca-validity-period-configured.png
...
images/12-certificate-database-location-configured.png
...
images/13-adcs-configuration-confirmation.png
...
images/14-adcs-configuration-successful.png
...
images/15-certification-authority-console.png
...
images/16-certificate-templates-visible.png
...
images/17-current-user-certificate-store-opened.png
...
images/18-active-directory-enrollment-policy-selected.png
...
images/19-certificate-types-not-available.png
...
images/20-domain-connectivity-and-logon-server-validated.png
...
images/21-user-certificate-template-available.png
...
images/22-user-certificate-enrollment-successful.png
...
images/23-user-certificate-installed-in-personal-store.png
...
images/24-issued-certificate-visible-on-ca.png
...
images/25-root-ca-trusted-on-client.png


Validation Summary

Test: AD CS role installed
Expected Result: Role installs successfully
Actual Result: Installation succeeded
Status: Passed

Test: CA configured
Expected Result: Enterprise Root CA configured
Actual Result: Configuration succeeded
Status: Passed

Test: CA console opens
Expected Result: MRTG-DC01-CA visible
Actual Result: CA visible in console
Status: Passed

Test: Certificate templates visible
Expected Result: Templates available on CA
Actual Result: Templates visible
Status: Passed

Test: User certificate enrollment policy available
Expected Result: AD enrollment policy visible
Actual Result: Policy visible
Status: Passed

Test: User certificate template available
Expected Result: User template selectable
Actual Result: Template available after policy refresh
Status: Passed

Test: User certificate enrollment
Expected Result: Enrollment succeeds
Actual Result: User certificate enrolled
Status: Passed

Test: Certificate appears in user store
Expected Result: Certificate installed locally
Actual Result: Certificate present in Personal store
Status: Passed

Test: Certificate appears on CA
Expected Result: Issued certificate visible
Actual Result: Certificate visible under Issued Certificates
Status: Passed

Test: Root CA trusted by client
Expected Result: Root CA in trusted store
Actual Result: MRTG-DC01-CA trusted
Status: Passed
...
images/26-post-lab-19-dc01-checkpoint.png
...
images/27-post-lab-19-client-checkpoint.png
...
Lab 20 will focus on automating identity lifecycle tasks with PowerShell, including user creation, account updates, group membership changes, and repeatable IAM administration workflows.
